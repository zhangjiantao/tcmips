...
--*/
{
   ...
   case 0x0043:
      ...
      AUDIO_PlayMusic(pScript->rgwOperand[0], pScript->rgwOperand[1] != 1, (pScript->rgwOperand[1] == 3 && pScript->rgwOperand[0] != 9) ? 3 : 0);
      break;
   ...
   case 0x0077:
      ...
      AUDIO_PlayMusic(0, FALSE,
         (pScript->rgwOperand[0] == 0) ? 2 : pScript->rgwOperand[0] * 3);

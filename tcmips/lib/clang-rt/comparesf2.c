...
CMP_RESULT __eqsf2(fp_t a, fp_t b) { return __lesf2(a, b); }
CMP_RESULT __ltsf2(fp_t a, fp_t b) { return __lesf2(a, b); }
CMP_RESULT __nesf2(fp_t a, fp_t b) { return __lesf2(a, b); }
CMP_RESULT __gtsf2(fp_t a, fp_t b) { return __gesf2(a, b); }
